...
<body>
    <form name="form_baixa" method="post" action="baixar_cartao2.php">	
        <div id="corpo">
            ...
            <div id="caixa_conteudo">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="62%"><h1 class="c_cinza">Contas a receber <img src="../img/marcador_setaDir.gif" align="absmiddle" /> <span class="c_preto"><?php print $titulo_pagina; ?></span> </h1>
                        </td>
                        <td width="38%"><div align="right">
                                <?php if ($acao == "alt") { ?>
                                    <a href="baixar_cartao.php?id=<?php print $id; ?>"><img src="../img/btn_fechar.gif" alt="Fechar" border="0" /></a>
                ...
                <div id="caixa_cad">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="72%" class="c_preto"><?php print ucwords($cartao); ?></td>
                        </tr>
                        <tr>
